...
//shops
router.get('/all-shops', authMiddleware.verifyToken([Role.admin, Role.user]), controller.showAllShop);
router.get('/one-shop/:id', controller.showShopById);
router.put('/change-shop/:id', authMiddleware.verifyToken([Role.admin, Role.user]), controller.updateShopById);
router.post('/create-shop/', authMiddleware.verifyToken([Role.admin, Role.user]), controller.createShop);
router.delete('/delete-shop/:id', authMiddleware.verifyToken([Role.admin, Role.user]), controller.deleteShopId);
